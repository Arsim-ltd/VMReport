...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PowerPath.aspx.cs" Inherits="VMReport.PowerPath" %>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
                ...
                <li class="active"><a runat="server" href="~/PowerPath.aspx">PowerPath</a></li>
