...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Datastores.aspx.cs" Inherits="VMReport.Datastores" %>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a runat="server" href="~/">Home</a></li>
                ...
                <li class="active"><a runat="server" href="~/Datastores.aspx">Datastores</a></li>
...
<div id="mySidenav" class="sidenav">
  <ul class="list-unstyled components mainlist">
    <li class="active"><a href="#vc_prd" data-toggle="tab">VC-Prd</a></li>
...
<div class="tab-content clearfix">
    <div class="tab-pane active" id="vc_prd" runat="server"></div>
