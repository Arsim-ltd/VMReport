...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Backup.aspx.cs" Inherits="VMReport.Backup" %>
    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a runat="server" href="~/">Home</a></li>
                ...
                <li class="active"><a runat="server" href="~/Backup.aspx">Backups</a></li>
...
<div id="mySidenav" class="sidenav">
  <ul class="list-unstyled components mainlist">
    <li class="active"><a href="#vcsa" data-toggle="tab">VCSA Backup</a></li>
...
<div class="tab-content clearfix">
    <div class="tab-pane active" id="vcsa" runat="server"></div>
