...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Snapshots.aspx.cs" Inherits="VMReport.Snapshots" %>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
                ...
                <li class="active"><a runat="server" href="~/Snapshots.aspx">Snapshots</a></li>
